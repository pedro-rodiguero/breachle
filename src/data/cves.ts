/**
 * CVE-dle dataset. Real, verifiable vulnerabilities only.
 * CVSS scores follow NVD (v3.x where assigned). Facts that need a human
 * double-check are marked with // VERIFY.
 *
...
export const CVES: Cve[] = [
  ...
  },
  {
    ...
    cveId: 'CVE-2017-0144',
    cvss: 8.1, // VERIFY: NVD CVSS v3.1 score
    vector: 'Network',
    year: 2017,
  ...
  },
  {
    ...
    aliases: ['Spectre v1'],
    cveId: 'CVE-2017-5753',
    cvss: 5.6, // VERIFY: NVD CVSS v3.1 score
    vector: 'Local',
    year: 2018,
  ...
  },
  {
    ...
    cveId: 'CVE-2016-5195',
    cvss: 7.0, // VERIFY: NVD CVSS v3.x score
    vector: 'Local',
    year: 2016,
  ...
  },
  {
    ...
    cvss: 6.8, // VERIFY: NVD CVSS v3.x score
  ...
  },
  {
    ...
    cveId: 'CVE-2014-3566',
    cvss: 3.4, // VERIFY: NVD CVSS v3.x score
    vector: 'Network',
    year: 2014,
    product: 'SSL 3.0',
  ...
  },
  {
    ...
    cveId: 'CVE-2016-0800',
    cvss: 5.9, // VERIFY: NVD CVSS v3.x score
    vector: 'Network',
    year: 2016,
  ...
  },
  {
    ...
    aliases: ['Ghost glibc'],
    cveId: 'CVE-2015-0235',
    cvss: 10.0, // VERIFY: CVSS v2 score (no v3 assigned at disclosure)
    vector: 'Network',
    year: 2015,
    product: 'GNU glibc',
    cwe: 'Buffer overflow',
  ...
  },
  {
    ...
    cveId: 'CVE-2015-1538',
    cvss: 9.8, // VERIFY: NVD CVSS v3.x score
    vector: 'Network',
    year: 2015,
    product: 'Android (libstagefright)',
    cwe: 'Integer overflow',
    description:
      'A malicious multimedia message could execute code on roughly a billion phones before the victim even opened it.',
  },
  {
    id: 'ProxyLogon',
    aliases: ['Proxy Logon'],
